...
module.exports = {
    ...
    run: async (bot, message, args) => {
        try {
            ...
            if (!args[0]) return message.reply("Please mention a valid member of this server");
            ...
            if(!mutee) return message.reply("Please mention a valid member of this server");

            if (mutee === message.member) return message.channel.send("Cannot mute yourself, dumbass!")
            if (mutee.roles.highest.comparePositionTo(message.guild.me.roles.highest) >= 0) return message.channel.send("I cant mute this user!")
